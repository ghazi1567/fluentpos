...
export class OrderApiService {
    ...
    getByTrackingNumber(id: string) {
        var url = `${this.baseUrl}GetByTrackingNumber/${id}`;
        return this.http.get(url);
    }
    confirmOrder(model: any) {
        return this.http.post(`${this.baseUrl}ConfirmOrder`, model);
    }
    returnOrder(model: any) {
        return this.http.post(`${this.baseUrl}ReturnOrder`, model);
    }
    ...
    getLoadsheetById(id: string) {
        return this.http.get(`${this.baseUrl}GetLoadsheetById/${id}`);
    }
    getLoadsheets() {
    ...
    scanTrackingNumber(model: any) {
        return this.http.post(`${this.baseUrl}ScanLoadSheetOrder`, model);
    }
    deliveredOrder(model: any) {
      return this.http.post(`${this.baseUrl}DeliveredOrder`, model);
  }
}
