...
@Component({
    selector: "app-stock-in-edit",
    templateUrl: "./stock-in-edit.component.html",
    styleUrls: ["./stock-in-edit.component.scss"]
})
export class StockInEditComponent implements OnInit {
    id: any;
    order: any;
