...
@Component({
  selector: 'app-assigned-to-outlet',
  templateUrl: './assigned-to-outlet.component.html',
  styleUrls: ['./assigned-to-outlet.component.scss']
})
export class AssignedToOutletComponent implements OnInit {
  ...
  gridReady(event): void {
    ...
    this.getOrders(OrderStatus.AssignToOutlet);
  }

  actionButtons: CustomAction[] = [
    new CustomAction("View Order", "View", "View", "visibility"),
    new CustomAction("Accept Order", "Accept", "Update", "check_circle"),
  ];
