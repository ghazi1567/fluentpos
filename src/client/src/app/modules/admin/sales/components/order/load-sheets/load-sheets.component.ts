...
export class LoadSheetsComponent implements OnInit {
    ...
    loadSheetData: any[] = [];
    constructor(private orderService: OrdersService, private toastr: ToastrService, public router: Router) {}
    ...
    onButtonClick(params) {
        ...
        if (params.button.key == "Edit") {
            this.router.navigateByUrl(`admin/sales/generate-load-sheet/${params.data.id}`);
        }
    }
    ...
    actionButtons: CustomAction[] = [
        ...
        new CustomAction("Edit", "Edit", "Update", "edit")
    ];
