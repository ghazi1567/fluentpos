...
export class UserService {
    ...
    getUsers(UserParams: UserParams): Observable<PaginatedResult<User>> {
        ...
        if (UserParams.pageNumber) params = params.append("pageNumber", UserParams.pageNumber.toString());
        ...
        return this.api.getAlls(params).pipe(map((response: PaginatedResult<User>) => response));
    }
    ...
    updateUser(User: User): Observable<IResult<User>> {
        return this.api.update(User).pipe(map((response: IResult<User>) => response));
    }
    ...
    getUserRoles(id: string): Observable<Result<UserRole>> {
        return this.api.getUserRoles(id).pipe(map((response: Result<UserRole>) => response));
    }

    updateUserRoles(id: string, request: UserRole): Observable<IResult<string>> {
        return this.api.updateUserRoles(id, request).pipe(map((response: IResult<string>) => response));
    }
    getUserBranchs(id: string) {
        return this.api.getUserBranchs(id).pipe(map((response: Result<UserBranch>) => response));
    }

    updateUserBranchs(id: string, request: UserBranch) {
        return this.api.updateUserBranchs(id, request).pipe(map((response: IResult<string>) => response));
    }
}
