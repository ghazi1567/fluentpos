...
{
    public class RemoveCommandValidator : AbstractValidator<RemoveOrganizationCommand>
    {
        public RemoveCommandValidator(IStringLocalizer<RemoveCommandValidator> localizer)
        {
            RuleFor(c => c.Id)
