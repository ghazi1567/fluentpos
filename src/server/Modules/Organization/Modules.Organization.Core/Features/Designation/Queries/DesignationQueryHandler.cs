...
namespace FluentPOS.Modules.Catalog.Core.Features
{
        ...
        IRequestHandler<GetDesignationByIdQuery, Result<GetDesignationByIdResponse>>
    {
        ...
        {
            Expression<Func<Designation, GetDesignationResponse>> expression = e => new GetDesignationResponse(e.Id, e.CreateaAt, e.UpdatedAt, e.OrganizationId, e.BranchId,e.Name,e.DepartmentId);
