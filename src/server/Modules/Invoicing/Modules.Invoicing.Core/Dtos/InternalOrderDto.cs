...
{
    public class InternalOrderDto : BaseEntityDto
    {
        ...
        /// </summary>
        public InternalAddressDto BillingAddress { get; set; }
        ...
        /// </summary>
        public IEnumerable<OrderFulfillmentDto> Fulfillments { get; set; }
        ...
        /// </summary>
        public InternalAddressDto ShippingAddress { get; set; }
