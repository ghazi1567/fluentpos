...
{
    internal class OvertimePlanningQueryHandler :
        IRequestHandler<GetOvertimePlanningQuery, PaginatedResult<OvertimeRequestDto>>
    {
        ...
        public OvertimePlanningQueryHandler(
...
#pragma warning disable RCS1046 // Asynchronous method name should end with 'Async'.
        public async Task<PaginatedResult<OvertimeRequestDto>> Handle(GetOvertimePlanningQuery request, CancellationToken cancellationToken)
#pragma warning restore RCS1046 // Asynchronous method name should end with 'Async'.
        {
            var queryable = _context.OvertimeRequests.AsNoTracking().AsQueryable();

            // string ordering = new OrderByConverter().Convert(request.OrderBy);
            string ordering = request.OrderBy;

            queryable = !string.IsNullOrWhiteSpace(ordering) ? queryable.OrderBy(ordering) : queryable.OrderByDescending(a => a.OvertimeDate);
            ...
            var response = _mapper.Map<PaginatedResult<OvertimeRequestDto>>(shiftPlannersList);
