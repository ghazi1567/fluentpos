...
{
    public class RegisterEmployeeRequestCommandValidator : AbstractValidator<RegisterEmployeeRequestCommand>
    {
        public RegisterEmployeeRequestCommandValidator(IStringLocalizer<RegisterEmployeeCommandValidator> localizer)
        {
