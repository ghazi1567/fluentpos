...
namespace FluentPOS.Modules.People.Core.Features.Customers.Queries
{
    internal class EmployeeQueryHandler :
        IRequestHandler<GetEmployeesQuery, PaginatedResult<GetCustomersResponse>>,
        IRequestHandler<GetEmployeeByIdQuery, Result<GetCustomerByIdResponse>>,
...
#pragma warning disable RCS1046 // Asynchronous method name should end with 'Async'.
        public async Task<PaginatedResult<GetCustomersResponse>> Handle(GetEmployeesQuery request, CancellationToken cancellationToken)
...
#pragma warning disable RCS1046 // Asynchronous method name should end with 'Async'.
        public async Task<Result<GetCustomerByIdResponse>> Handle(GetEmployeeByIdQuery query, CancellationToken cancellationToken)
#pragma warning restore RCS1046 // Asynchronous method name should end with 'Async'.
        {
